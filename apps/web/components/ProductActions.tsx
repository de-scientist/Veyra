  ...
  return (
    <div className="product-actions">
      ...
      <div className="quantity-row">
        ...
        <input id="quantity" type="number" min="1" max="20" value={quantity} onChange={(event) => setQuantity(Math.max(1, Math.min(20, Number((event.target as HTMLInputElement).value) || 1)))} />
      </div>
