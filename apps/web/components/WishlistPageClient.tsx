...
export function WishlistPageClient() {
  ...
  if (!items.length) return <div className="empty-state"><h1>Your wishlist is waiting</h1><p>Save pieces you want to revisit when you are ready.</p><Link className="button" href="/shop">Explore the shop</Link></div>;
