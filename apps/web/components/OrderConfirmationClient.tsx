...
export function OrderConfirmationClient({ orderNumber, confirmationToken }: Props) {
  ...
  async function checkStatus() {
    ...
    try {
      ...
      setPayment(result.payment);
      setPaymentMessage(result.refreshed ? 'Payment status updated.' : result.pending ? 'Still waiting for M-Pesa confirmation. You can check again shortly.' : '');
    } catch (reason) {
