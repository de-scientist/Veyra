      ...
      <div className="product-workspace__layout">
        <div className="product-workspace__main">
          <section className="workspace-card" aria-labelledby="edit-details-heading">
            <h2 id="edit-details-heading">Product information</h2>
          ...
          <section className="workspace-card" aria-labelledby="product-media-heading">
            <h2 id="product-media-heading">Product media</h2>
      ...
      <section className="workspace-card" aria-labelledby="edit-variants-heading">
        ...
        <div className="product-workspace__side">
          <section className="workspace-card" aria-labelledby="edit-inventory-heading">
            <h2 id="edit-inventory-heading">Inventory</h2>
            <p className="muted-copy workspace-card__hint">
              Stock is audited and managed from Inventory — variant creation starts each variant at zero on hand.
            </p>
            <Link href="/admin/inventory" className="button button--secondary">Open Inventory</Link>
          </section>

          <section className="workspace-card" aria-labelledby="edit-taxonomy-heading">
            <h2 id="edit-taxonomy-heading">Categories &amp; collections</h2>
          ...
          <section className="workspace-card" aria-labelledby="edit-attrs-heading">
            <h2 id="edit-attrs-heading">Attributes</h2>
            <ul className="pill-nav" aria-label="Available attributes">
              {attributes.map((attribute) => (
                <li key={attribute.id}><span>{attribute.name}</span></li>
              ))}
            </ul>
            <Link href="/admin/attributes" className="button button--secondary">Manage Attributes</Link>
          </section>

          <section className="workspace-card" aria-labelledby="edit-seo-heading">
            <h2 id="edit-seo-heading">SEO</h2>
            <dl className="media-meta">
              <dt>Slug</dt>
              <dd>/products/{product.slug}</dd>
              <dt>Title</dt>
              <dd>{product.name} | JB Mercantile</dd>
            </dl>
          </section>
